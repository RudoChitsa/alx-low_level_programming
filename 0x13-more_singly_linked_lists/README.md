...
11. 100-reverse_listint.c - function that reverses a listint_t linked list with the specifications:
...
12. Can print lists with a loop
...
13. Can free lists with a loop
Should go though the list only once
Sets the head to NULL
14. 103-find_loop.c - function that finds the loop in a listint_t list with the specifications:
